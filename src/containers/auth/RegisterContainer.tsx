...
import { useRegisterMutation } from '@/services/rtk/profileApi';
import { LoginUser } from '@/services/slices/userSlice';
import { isSuccess } from '@/utils/utils';
import { registerValidation } from '@/validators/auth/auth.validators';
    ...
    <div>
      <div className="max-w-xl lg:max-w-3xl">
        ...
        <div className="relative -mt-16  lg:block hidden">
          ...
          <h1 className="mt-2 mb-3 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl">
            Register
          </h1>
        ...
        >
          <Form className="mt-5 grid grid-cols-6 gap-6">
            <div className="col-span-6">
              <InputField label="Name" required name="name" type="text" placeholder="Enter Name" />
            </div>
            <div className="col-span-6">
              <InputField
                label="Email"
