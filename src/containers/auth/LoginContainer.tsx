...
import { useLoginMutation } from '@/services/rtk/profileApi';
import { LoginUser } from '@/services/slices/userSlice';
import { isSuccess } from '@/utils/utils';
import { loginValidator } from '@/validators/auth/auth.validators';
    ...
    <div>
      {/* <section className="bg-white">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6 mb-5">
            <img
              alt=""
      ...
      <div className="max-w-xl lg:max-w-3xl">
        ...
        <div className="relative -mt-16  lg:block hidden">
          ...
          <h1 className="mt-2 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl mb-5">
            Welcome Back!
          </h1>
